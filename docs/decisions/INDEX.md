...
- [ADR 0023: Keep External Platform Services Outside the Persefonia Deployment Unit](0023-keep-external-platform-services-outside-the-persefonia-deployment-unit.md) — defines the current deployment ownership boundary while keeping selected edge, identity, and mail platform services externally operated.
