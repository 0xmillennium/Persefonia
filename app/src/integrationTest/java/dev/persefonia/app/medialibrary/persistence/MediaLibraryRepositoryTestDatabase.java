...
@ActiveProfiles("test")
abstract class MediaLibraryRepositoryTestDatabase {
    static final SharedPostgresTestServer.Database POSTGRES = SharedPostgresTestServer.integrationDatabase();
    ...
    @BeforeEach
    void resetMediaTables() {
        migrateOnce();
        jdbc.execute("TRUNCATE media.assets CASCADE");
    }
